...
- 请各位同学提交**pdf格式**的邮件，不要提交图片或者word文档。（但你可以选择将作业拍照拍下来再将图片转成pdf），注意由于本次课程两个班的教学时间安排会有区别，导致进度会有差别，从而请在命名作业文件的时候一定要注明所在的教学班级，如果你是周二下午6-7节课的同学，文件请命名为：**学号-姓名-<span style="color:red;">2班</span>-线代第x次作业**，如果你是周二下午8-9节可得同学，则请将作业命名为：**学号-姓名-<span style="color:red;">1班</span>-线代第x次作业**。**第x次**请以发布的作业标题为准。
